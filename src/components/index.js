...
export Town from './IndexPage/Town/Town';
export Features from './IndexPage/Features/Features';
export Bridge from './IndexPage/Bridge/Bridge';
export Reasons from './IndexPage/Reasons/Reasons';
